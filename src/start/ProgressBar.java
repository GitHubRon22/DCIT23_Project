...
public class ProgressBar {
    ...
    public static void main(String[] args) {
        ...
        photoPanel.setBounds(0, 0, frame.getWidth(), frame.getHeight());
        photoPanel.setOpaque(false); // Make the panel transparent

        // Create the progress bar
        progressBar = new JProgressBar(SwingConstants.HORIZONTAL);
        progressBar.setBounds(70, 140, 300, 20);
        ...
        percentageLabel.setBounds(185, 170, 50, 20);
        ...
        startButton.setBounds(120, 190, 180, 30);
