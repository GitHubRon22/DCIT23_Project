...
public class GameArea extends JPanel {
    ...
    public boolean isBlockOutOfBounds() {
        if (block.getY() < 0) {
            block = null;
            playOverSound("/resources/game_over.wav");
            return true;
        }
        return false;
    }
    ...
    public boolean moveBlockDown() {
        ...
        block.moveDown();
        playBeepSound("/resources/beep.wav");
        repaint();
    ...
    public void dropBlock() {
        ...
        while (checkBottom()) {
            block.moveDown();
            playDropSound("/resources/drop.wav");
    ...
    public void rotateBlock() {
        if (block == null) return;
        block.rotate();
        playBlopSound("/resources/blop.wav");
    ...
    private void playDropSound (String soundFilePath) {
        try {
            Clip clip = AudioSystem.getClip();
            clip.open(AudioSystem.getAudioInputStream(getClass().getResource(soundFilePath)));
            clip.start();
    ...
    private void playBeepSound (String soundFilePath) {
        try {
            Clip clip = AudioSystem.getClip();
            clip.open(AudioSystem.getAudioInputStream(getClass().getResource(soundFilePath)));
            clip.start();
    ...
    private void playOverSound(String soundFilePath) {
    	try {
            Clip clip = AudioSystem.getClip();
            clip.open(AudioSystem.getAudioInputStream(getClass().getResource(soundFilePath)));
            clip.start();
    ...
    private void playBlopSound(String soundFilePath) {
    	 try {
             Clip clip = AudioSystem.getClip();
             clip.open(AudioSystem.getAudioInputStream(getClass().getResource(soundFilePath)));
             clip.start();
